 ...
 *  @author Stan Mihnea
 *  
 *  clasa pentru a vedea lista istoricului de bilete, se foloseste de calsa ResultSetTableModel
 */
public class History extends JInternalFrame {
   ...
   private static final String DEFAULT_QUERY = "select * from bilete";
    public History() {
        ...
        printButton = new JButton("print the concerts");
