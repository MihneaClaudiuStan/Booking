 ...
 *  @author Stan Mihnea
 *  
 *  clasa pentru pagina de utilizator
 */
public class UserProfile implements ActionListener {
    ...
    UserProfile(String Username) {
        ...
        book_ticket = new JMenu(" Tickets ");
        view_history = new JMenu("View Previous Tickets");
    ...
    /**
     * 
     *  functiile de cumparare de bilet,vazut istoric si exit sau logout
     */
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == btn_ticket) {

            SelectConcert b = new SelectConcert();
            desktop.add(b);
